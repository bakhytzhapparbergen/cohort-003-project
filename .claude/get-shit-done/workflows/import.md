...
```bash
node "/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs({phase}): import plan from {basename FILEPATH}" --files .planning/phases/{phase}/{plan}-PLAN.md .planning/ROADMAP.md
```
