...
```bash
INIT=$(node "/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
