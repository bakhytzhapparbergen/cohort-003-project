...
- **Global scope**: `/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/notes/`)
...
2. Glob `/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bakhyt.zhapparbergenov/Desktop/projects/cohort-003-project/.claude/notes/` — works in any directory
